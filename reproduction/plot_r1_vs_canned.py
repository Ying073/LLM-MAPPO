...
print()
print('=== 关键 takeaway (诚实版) ===')
print('1. R1 reward 起点 -7182 远负于 Canned +107 (R1 scale 系数更激进 30-50x, 体现真 LLM 思考)')
print('2. 两者最终都把 area_unc 推到 ~0: R1 0.00003 / Canned 0.0000 (都搜完所有目标)')
print('   - 注意: 早期版本写 "Canned 剩 8%/0.082" 是错的, 0.082 只是 Canned outer-3 中间值')
print('3. 完成度上两者无显著差距, 差别主要在 reward scale 与收敛动态 (R1 需更多 ep 稳态)')
print('4. 两条曲线都收敛, 说明 LRS 算法机制对, 不管 R^best 来自 R1 还是 paper')