...
2. **两者最终都把 area_unc 推到 ~0** (R1 0.00003, Canned 0.0000, 都搜完所有目标)。 **注意: 早期文档写的 "Canned 剩 8% (0.082)" 是错的**, 0.082 只是 Canned outer-3 的中间值, 到 outer-10 之后 Canned 稳定在 0. 在"区域搜索完成度"上 R1 与 Canned 差距不大, 这一点要诚实。
